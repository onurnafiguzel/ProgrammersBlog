...
namespace ProgrammersBlog.Entities.Dtos
{
    public class ArticleUpdateDto
    {
        ...
        [MinLength(5, ErrorMessage = "{0} alanı {1} karakterden küçük olmamaıdır")]
        public string Title { get; set; }

        [DisplayName("İçerik")]
        [Required(ErrorMessage = "{0} alanı boş geçilmemelidir.")]
        [MinLength(20, ErrorMessage = "{0} alanı {1} karakterden küçük olmamaıdır")]
        ...
        [MinLength(0, ErrorMessage = "{0} alanı {1} karakterden küçük olmamaıdır")]
